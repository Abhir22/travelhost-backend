...
Package: {
  ...
  PackageCityDayMeal: {
    columns: {
      ...
      mealType: { type: "String", nullable: false }, // Breakfast, Lunch, Dinner
      provider: { type: "String", nullable: false }, // Hotel / Outside
